    ...
    const observer = new IntersectionObserver(function(entries) {
        entries.forEach(entry => {
            if (entry.isIntersecting && !countersStarted) {
                ...
                const counters = [
                    { element: document.querySelector('.stat-item:nth-child(1) .stat-number'), target: '500+' },
                    { element: document.querySelector('.stat-item:nth-child(2) .stat-number'), target: '10+' },
                    { element: document.querySelector('.stat-item:nth-child(3) .stat-number'), target: '20+' },
